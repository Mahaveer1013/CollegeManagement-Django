# Generated by Django 5.0.7 on 2024-07-21 04:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.assignmentquestions')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name='attendance',
            index=models.Index(fields=['subject', 'student', 'date'], name='main_app_at_subject_5356c1_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='attendance',
            unique_together={('subject', 'student', 'date', 'period')},
        ),
    ]
