...
urlpatterns = [
    ...
    path("admin/view-certificates/", hod_views.admin_view_certificate, name='admin_view_certificate'),
    path("admin/exam/filter", hod_views.exam_filter_page, name='exam_filter_page'),
    path("admin/download_result_template", hod_views.download_result_template, name='download_result_template'),
    path("admin/upload_result", hod_views.upload_result, name='upload_result'),
    path("admin/view_result", hod_views.view_result, name='view_result'),
    ...
    path("timetable/staff/", hod_views.hod_staff_timetable, name="hod_staff_timetable",),
    path("timetable/class/", hod_views.hod_class_timetable, name="hod_class_timetable",),
    ...
    path('get_student_profile', hod_views.get_student_profile, name='get_student_profile'),
    path('get_class_by_exam', hod_views.get_classes_by_exam, name='get_classes_by_exam'),
    path('admin/add_result/', hod_views.add_result, name='add_result'),
    path('get_staff_profile', hod_views.get_staff_profile, name='get_staff_profile'),
...
#     path("notice/view", staff_views.view_notice, name='view_notice'),
     ...
     path("staff/mentee/", staff_views.show_mentees, name='show_mentees'),
...
#          staff_views.update_attendance, name='update_attendance'),
    ...
    path("student/upload/certificates/", student_views.student_upload_certificate, name='student_upload_certificate'),
    path('certificates/delete/<int:certificate_id>/', student_views.delete_certificate, name='delete_certificate'),
    path("student/view/certificates/", student_views.student_view_certificate, name='student_view_certificate'),
    path("student/disciplinary_action/", student_views.student_disciplinary_action, name='student_disciplinary_action'),
